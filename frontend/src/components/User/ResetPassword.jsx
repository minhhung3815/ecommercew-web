              ...
              <form onSubmit={handleSubmit}>
                ...
                <div class="flex flex-col w-full gap-4">
                  ...
                  <div class="flex flex-col gap-2.5 mt-2 mb-32">
                    <p class="text-xs text-primary-grey text-left">By continuing, you agree to <span class="text-primary-blue"> Terms of Use</span> and <span class="text-primary-blue"> Privacy Policy.</span></p>
